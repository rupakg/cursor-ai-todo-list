  ...
  return (
    <div className="flex items-center gap-4">
        ...
        {filters.map(({ label, value }) => (
          <button
            ...
            className={`rounded-lg px-4 py-2 text-sm font-medium transition-colors ${
              current === value
                ? "bg-[hsl(var(--purple))] text-[hsl(var(--purple-foreground))]"
                : "text-gray-600 hover:bg-[hsl(var(--purple)/0.1)]"
            }`}
          >
            {label}
          </button>
      ...
      <div className="flex items-center gap-2">
        ...
        >
          <Select.Trigger className="flex h-9 w-[180px] items-center justify-between rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 disabled:cursor-not-allowed disabled:opacity-50">
